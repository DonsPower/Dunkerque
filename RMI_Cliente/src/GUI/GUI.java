...
// ------------------------------ FIELDS ------------------------------
    ...
    private ImageIcon hitIcon = new ImageIcon(getClass().getResource(""));
    private ImageIcon missedIcon = new ImageIcon(getClass().getResource(""));
    private ImageIcon destroyedIcon = new ImageIcon(getClass().getResource(""));
    private ImageIcon shipIcon = new ImageIcon(getClass().getResource(""));
